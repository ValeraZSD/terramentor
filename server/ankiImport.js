...
// Numeric character references, both bases. Decimal-only was the shipped rule
// and it survived because the fields this importer used to read rarely carried
// one; reading the fields the deck's TEMPLATE points at surfaced it immediately,
// as "The poems describe the poet&#x27;s feelings" on 5,168 Dutch cards. The
// pair `fromCodePoint`/`&#x` also fixes astral characters, which `fromCharCode`
// silently truncated.
