 ...
 *
 * The unit is a STUDY DAY. This used to be denominated in hours — capacity was
 * `days * hoursPerDay` and the cursor was divided by `hoursPerDay` again to get
 * back to a day index, so the setting cancelled itself out of every date it
 * produced. Days are what the allocator actually distributes.
 */
