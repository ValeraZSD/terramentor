...
//
// Every long-running AI generation (tutor chat, quiz/boss fight, flashcards,
 ...
 *
 * A failure used to be a single string, which is enough to say "something went
 * wrong" and nothing else — not which model, not which endpoint, not how far it
 * got, not whether it is worth retrying. That is unhelpful for the learner and
 * useless for a bug report from someone else's machine, which is the case that
 * matters once this ships.
 *
...
function createTask({ kind, label, projectId = null, nodeId = null, projectName = null, projectColor = null, meta = null, dedupeKey = null, run }) {
    ...
    const task = {
        ...
        startedAt: null,
        finishedAt: null,
        progress: { thinking: 0, content: 0, percent: null, phase: null, message: null },
        content: '',
        thinkingText: '',
        terminalEvent: null,
        errorMessage: null,
...
function registerExternal({ kind, label, projectId = null, projectName = null, projectColor = null, cancel }) {
    const task = {
        ...
        finishedAt: null,
        progress: { thinking: 0, content: 0, percent: 0, phase: null, message: null },
        content: '',
        thinkingText: '',
        terminalEvent: null,
        errorMessage: null,
