...
//
// One pass, not two: a transcription pass between the photograph and the
// marker loses exactly what marking needs. That split is the right shape for
// pdfRecovery.js, where nothing downstream of recovery needs to SEE a page,
// only to read it. Marking is the opposite. Which working sits under
...
// of prose — a transcriber's "[diagram: standing wave pattern with 3
// antinodes]" stands for a diagram that is correct and fully labelled, and a
// marker that correctly refuses to credit what it cannot see marks it not met.
//
