...
//
// The mark used to be seven files written at build time and never looked at
// again. Three of them are now a function of three settings rows (which cut of
// the mark, what colour the tile is, how round it is), so the files a browser
// fetches have to be rendered when they are asked for rather than when the
// project was built.
//
