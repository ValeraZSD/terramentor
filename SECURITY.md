...
endpoint **you** configure. There is no vendor, no account, no cloud component, and no
counterparty holding your data.
...
## The update check, stated plainly
...
## The activity log, stated plainly
