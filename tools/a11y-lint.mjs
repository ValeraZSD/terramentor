...
//
// Advisory, and not part of `npm test`: it reports, it does not gate. Heuristic
// and conservative (opening-tag
...
for (const file of files) {
  ...
  // the real file — and a button whose only "words" were in a comment is still
  // correctly seen as wordless.
