 ...
 *
 * Progress used to be a count of ticks: a leaf was 1 if somebody had marked it
 * completed or skipped, and 0 otherwise. That describes a written course and
 * says nothing true about a topic whose content IS cards — "A Frequency
 * Dictionary of Dutch" read 0 / 6 items and 0% with 471 of its 5,168 cards met.
 * Nobody is ever going to tick "Core" off by hand; the work is the cards.
 *
