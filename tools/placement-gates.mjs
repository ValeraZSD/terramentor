...
let elig = checkMasteryEligibility(probed, THRESHOLD, BOSS_PASS);
...
updateMasteryFromAttempt(probed, 1, 1, 'quiz', { questionType: 'true_false' });
elig = checkMasteryEligibility(probed, THRESHOLD, BOSS_PASS);
...
updateMasteryFromAttempt(proveMe, 5, 5, 'boss_fight', { questionType: 'multiple_choice' });
check('a passing assessment still clears a seeded topic',
    checkMasteryEligibility(proveMe, THRESHOLD, BOSS_PASS).eligible);
