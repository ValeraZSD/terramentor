...
console.log('\n--- the gallery dissolve: one motion, not three ---');
{
    ...
    // commit that starts the dissolve. With `from { opacity: 1 }` the press put
    // the stage at FULL brightness on the first frame and the un-mute
    // transition then ran grayscale 1 → 0 underneath the fade: the sample
    // popped, coloured in and disappeared at once (measured over a real press:
