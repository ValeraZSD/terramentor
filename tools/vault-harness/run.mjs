...
// They are transparent inputs laid over a drawn box, which is how the rest of
// this app draws checkboxes — still focusable, unlike the `hidden` the older
// modal used, and still the thing a click on the box lands on.
check('the inputs are transparent over the box, not display:none (still focusable)',
    boxes.every(b => b.className.includes('opacity-0') && !/\bhidden\b/.test(b.className)), true);
