...
// MIN_GATE_QUESTIONS answered at at least `bossPass`. Both are `>=`, and both
// used to be able to become `>` without a single assertion noticing: nothing
// here tested a score or a length sitting exactly ON the bar. `passed_assessment`
