...
- Keep product/technical names untranslated: Terramentor, Ollama, Anki, FSRS, Docker, OpenAI, API, PDF, URL, JSON, Tailscale, llama.cpp, LM Studio, OpenRouter, SearXNG, Boss Fight.
