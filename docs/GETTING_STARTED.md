...
- **The assistant** (the speech-bubble icon, or press **a**): one conversation that sees every
  ...
  screen. It can look up a course's progress for itself, and it can prepare a mastery check, a
  flashcard or a note for your Inbox, but nothing is added until you press the button under its
  answer. The per-topic **AI Tutor** lives inside a topic and goes deeper on that one thing.
