 ...
 *
 * The app used to say "this can take a minute or two on slower local hardware"
 * unconditionally. That is actively misleading for anyone pointed at an
 * OpenAI-compatible endpoint or an Ollama `:cloud` model: nothing is running on
