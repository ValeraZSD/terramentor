 ...
 * cannot be reached. The feed and the quiz carrying their own copies, with
 * slightly different fallbacks, leaves a format added to one silently
 * ungradeable in the other — so there is exactly one.
 */
