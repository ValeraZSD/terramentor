        ...
        >
            <div
                ...
                /* A COLUMN, not a scrolling block: the header and the footer are
                   ...
                   UI scale. It used to be the whole card that scrolled, and
                   measured at 160% on a 375x812 phone that put Save ~200px below
                   the bottom of the screen with nothing able to reach it. */
            ...
            >
                {/* Title and close only. The sentence under it used to live here
                    too, in a column between a fixed-width icon and a fixed-width
                    close button: at 160% UI scale on a 390px phone that left it
                    ~186px and it wrapped onto SEVEN lines, pushing the scrolling
                    part of the dialog down to two visible lines of text. It says
