        ...
        return (
            <div className="p-4 space-y-6">
                ...
                <div className="text-center py-12">
                    ...
                    <p className="text-slate-500 dark:text-slate-400 mt-2">{t("You reviewed all {{length}} flashcards", { length: flashcards.length })}</p>
            ...
            >
                ...
                <div className={`h-full overflow-y-auto overscroll-contain p-4 sm:p-6 rounded-2xl border-2 transition-colors duration-300 bg-white dark:bg-slate-800 ${queue.flipped
                    ...
                    <div className="flex flex-col items-center justify-center min-h-full text-center">
                        <span className="text-xs uppercase tracking-wider text-slate-500 dark:text-slate-400 mb-4">
