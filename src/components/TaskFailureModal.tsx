 ...
 *
 * A failure used to be one line in the dock — "Generation failed" — which says
 * something went wrong and nothing else. That is bad for the learner, who
 * cannot tell a dead model from a bad prompt from a network blip, and useless
 * for a bug report from someone else's machine, which is the case that starts
