 ...
 * Lightness is not brightness, so a dark accent put the untouched end wherever
 * its hue happened to land: measured on the default deep violet, step 0 came
 * out at luminance 0.012 against a 0.009 surface — 1.05:1, a bubble you cannot
