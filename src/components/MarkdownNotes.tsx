        ...
        return (
            <div className="group/notes relative">
                ...
                {/* An editable field is RECESSED into the panel it sits on, in
                    ...
                    slate-800 one. It used to be `bg-white dark:bg-slate-800/60`,
                    i.e. the panel's own colour in both — 60% of slate-800 over
                    slate-800 composites to exactly slate-800 — so the Details tab
                    was one flat sheet in dark mode and only the borders said where
                    a field began. */}
                <div
                    {...previewTap}
