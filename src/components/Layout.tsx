...
export default function Layout({ children }: { children: ReactNode }) {
    ...
    const accentStyle = (view === 'workspace' && currentProject?.color
        ? {
            '--accent-rgb': accentSolidTriplet(currentProject.color),
            '--accent-fg-rgb': accentFgTriplet(currentProject.color, isDarkTheme(theme)),
        }
    ...
    return (
        ...
        <div className="flex-1 min-w-0 flex flex-col">
            ...
            {/* The Mastery Gate ("Boss Fight") lives at the app root, not in the
