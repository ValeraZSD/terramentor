 ...
 *
 * It used to be written twice, and the two copies had drifted: the tutor showed
 * the provider and the model but only a two-state dot (green/amber, so an
 * unreachable server looked the same as no model selected), while the assistant
 * had the four-state health dot but hid the provider in a tooltip. This is the
 * union — provider · model · four-state dot — so the answer to "what is
 * answering me" reads identically wherever the learner asks it.
 *
