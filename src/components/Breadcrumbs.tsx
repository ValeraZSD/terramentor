 ...
 * detail panel renders right below as one editable title. (An `ancestorsOnly`
 * flag used to make that optional; nothing ever passed `false`, so the second
 * branch was a rule with no caller.)
 *
