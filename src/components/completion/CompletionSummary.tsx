...
export default function CompletionSummary() {
    ...
    // nothing from where it was written.
    const accentStyle = {
    ...
    const save = async () => {
        ...
        try {
            ...
            const base = readVisualPalette(theme);
            ...
            const blob = await renderCertificate({
                ...
                // theme it is the accent itself — so the tick on the badge was
                // painted violet on violet and disappeared. `readableOn` picks
        ...
        <div className="fixed inset-0 z-[70] flex items-stretch justify-center sm:items-center sm:p-4" style={accentStyle}>
            ...
            >
                ...
                <div className="flex-1 overflow-y-auto px-5 pb-4 pt-6 text-center">
                    ...
                    <p className="mt-3.5 text-[11px] font-semibold uppercase tracking-[0.16em] text-slate-500 dark:text-slate-400">
                        {eyebrow}
                    </p>
                    ...
                    {timeline && span && (
                        <div className="mt-5 border-t border-slate-100 pt-4 dark:border-slate-800">
                            <ActivityBars
                                ...
                                label={(start, done) => t("{{date}}: {{done}} things done", {
