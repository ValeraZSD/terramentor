...
export default function Workspace() {
    ...
    // The Mastery Gate ("Boss Fight") modal is mounted in Layout, not here — the
    ...
    const viewTabs = ([
        ...
        // Not a destination on the rail: it is the feed pointed at one topic,
        // reached from that topic's Study button. Listed only while open so the
        // rail shows where you are and offers the way back.
        { key: 'study', label: tr("Study"), icon: BookOpen, when: false },
        ...
        <div className="h-full flex flex-col overflow-hidden">
            ...
            <div className="flex-1 flex overflow-hidden">
                ...
                <div className="flex-1 flex flex-col overflow-hidden bg-slate-100 dark:bg-slate-900 min-w-0">
                    ...
                    {workspaceView === 'study' && studyNodeId != null && <FeedView studyNodeId={studyNodeId} />}
                </div>
