                ...
                <div className="flex flex-wrap sm:flex-nowrap items-center gap-x-2 sm:gap-x-3 gap-y-1">
                    ...
                    <div className="order-last sm:order-none basis-full sm:basis-auto sm:flex-1 min-w-0 flex items-center gap-1.5 text-xs overflow-hidden">
                        ...
                        {deadline && (() => {
                            ...
                            // Both of these used to be English template literals
                            // assembled here and handed to t() as a {{placeholder}},
                            // which translates the frame and never the sentence: the
                            // chip read "22d behind" inside a fully Ukrainian header.
                            // The day counts are composed through the shared plural
                            // key so a language with more than two forms gets them.
                            const metric = behind
