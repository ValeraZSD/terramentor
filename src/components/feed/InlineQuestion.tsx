    ...
    return (
        <div>
            ...
            {/* The verdict is a MARGIN, not a box.
                It used to be a filled, bordered card — which then contained the
                expected answer, the explanation, and a second bordered card for
                "Teach me this", which could itself contain a chart in a third
                frame. Four nested outlines around one wrong answer, each drawn to
                say "this belongs together" and collectively saying nothing. One
                coloured rule down the left carries the verdict just as loudly and
                leaves the content room to have structure of its own. */}
            {result && (
