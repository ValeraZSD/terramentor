                            ...
                            <div className={`flex items-center gap-3 rounded-xl border p-3 transition-colors ${isCurrent
                                ...
                                >
                                    <div className="flex items-center gap-2">
                                        ...
                                        {isCurrent && (
                                            <span className="shrink-0 rounded-full bg-accent/15 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-accent-fg">
                                                {tr("You are here")}
                                            </span>
                                        )}
                                        {done && !isCurrent && (
                                    ...
                                    <div className="mt-2">
                                        <DeckProgress
                                            ...
                                            states={stage.states}
                                            height="h-2"
                                            label={tr("{{title}}: {{fmt}} of {{fmt2}} cards met", { title: stage.title, fmt: fmt(stage.seen), fmt2: fmt(stage.cards) })}
                                        />
                                    </div>
