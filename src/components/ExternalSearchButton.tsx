    ...
    return (
        <div ref={wrapRef} className={`relative inline-block ${className}`}>
            ...
            {open && (
                <div
                    role="menu"
                    className="absolute right-0 top-full z-30 mt-1 min-w-52 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 shadow-lg py-1"
                >
