...
/**
 * The widest a chart is drawn. A chart used to be capped at 720px and
 * left-aligned, so in the assistant panel on a desktop — 1100px of card — it
 * filled the left 60% and left the rest as bare dark background, which read
 * as a chart that had failed to scale. Past this width a five-bar chart is
 * five slabs; below it, on the phone, every pixel is used.
 */
