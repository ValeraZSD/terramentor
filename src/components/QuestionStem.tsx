 ...
 *
 * The second used to be impossible, and it read as a design decision — it was
 * not, it was this component's one branch. A graded question in a photo-based
 * subject (a driving theory exam, a radiograph, a specimen) could only be
 * demoted to a self-marked flashcard, which is the surface that cannot clear
 * the mastery gate. Nothing else was in the way: `markdownSanitize.ts` already
