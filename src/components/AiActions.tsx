import { Globe, FolderSearch, Loader2, Check, Search } from 'lucide-react';
                ...
                return (
                    ...
                    >
                        ...
                        <span className="min-w-0">
                            ...
                            {' '}
                            <span className="text-slate-500 dark:text-slate-400">“{a.arg}”</span>
                            {!running && typeof a.count === 'number' && (
                                <>
                                    {' · '}
                                    <span>{a.count === 0
                                        ? tr("nothing")
