 ...
 * project's AI (study chat, quizzes, Boss Fights) and export the whole project
                ...
                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 mb-4">
                    <div>
                        ...
                        <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
                            {t("Upload your own materials — curriculum, notes, textbooks, past exams. They become searchable text the AI uses to ground answers, quizzes and Boss Fights. Originals stay on your machine.")}
                        </p>
                    </div>
                    <div className="relative self-start shrink-0 flex items-center gap-2">
                        ...
                        {showOptions && (
                            <>
                                ...
                                <div className="absolute right-0 mt-1.5 z-20 w-72 p-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 shadow-lg">
