...
export interface ExportData {
    /**
     * Legacy. Exports used to carry a top-level `version: "2.0"` describing the
     * parser; nothing ever read it and no v1 branch existed, so it is no longer
     * written. Still optional here because a user's older file may have one.
     */
    version?: string;
    exported_at: string;
    project: {
