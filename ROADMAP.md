...
- **More ways to answer.** A graded question is not only "pick one of four": the
  ...
  **assemble** — drop tokens into slots (balance an equation, build a sentence,
  label a diagram); **speak** a sentence, transcribed locally (never the browser's speech
  API, which phones home) and graded as a short answer; and a **photographed** answer that
...
- **A curriculum marketplace.** Architected already — the vault's content-addressed storage
